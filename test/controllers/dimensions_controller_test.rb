...
class DimensionsControllerTest < ActionController::TestCase
  ...
  test "should create dimension" do
    assert_difference('Dimension.count') do
      post :create, dimension: { board_id: @dimension.board_id, length: @dimension.length, thickness: @dimension.thickness, volume: @dimension.volume, width: @dimension.width }
    end
  ...
  test "should update dimension" do
    patch :update, id: @dimension, dimension: { board_id: @dimension.board_id, length: @dimension.length, thickness: @dimension.thickness, volume: @dimension.volume, width: @dimension.width }
    assert_redirected_to dimension_path(assigns(:dimension))
  end
